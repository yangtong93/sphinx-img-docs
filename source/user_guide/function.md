...
It is used to align multiple images or data to achieve the best match in space or features. The registration algorithm makes the corresponding points, features or structures consistent between different images or data by calculating the transformation parameters.
